...
import { deleteProfileCollection, updateProfileCollection } from '../actions/profileCollection';


class ProfileCollectionScreen extends Component {
  ...
  return fetch(this.props.collection.url)
    ...
    .then((responseJson) => {
      this.setState({
        ...
        this.props.updateProfileCollection(this.state.collectionDataSource)
      });
...
const mapStateToProps = (state, ownProps) => {
  return {
    collection: state.profileCollections.byId[ownProps.route.params.id]
  }
}

const mapDispatchToProps = dispatch => {
  return {
    deleteProfileCollection: (id) => {
      dispatch(deleteProfileCollection(id))
    },
    updateProfileCollection: (collection) => {
      dispatch(updateProfileCollection(collection))
    }
  }
}

export default connect(mapStateToProps, mapDispatchToProps)(ProfileCollectionScreen)
